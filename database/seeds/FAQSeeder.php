...
class FAQSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('faq')->insert([
            ...
            'description' => '<p>Európsky program Erasmus má dlhoročnú tradíciu. Od akademického roka 2014/2015 existuje ako integrovaný program Erasmus+ pre obdobie rokov 2014 – 2021, ktorý poskytuje široké možnosti mobilít študentov a zamestnancov.</p>
	<h3>Erasmus+ podporuje 3 kľúčové aktivity:</h3>
	
	<ul>
		<li>KA1 = mobility jednotlivcov</li>
		<li>KA2 = strategické partnerstvá</li>
		<li>KA3 = reforma politík vrátane programu Jean Monnet a program Šport</li>
	</ul>
    
	<p>V rámci kľúčovej aktivity KA1 (Mobility jednotlivcov) Univerzita Konštantína Filozofa v Nitre realizuje mobility štúdium a stáž pre študentov a výučba a školenie pre zamestnancov. Študenti a zamestnanci majú možnosť uchádzať sa o Erasmus+ mobilitu v niektorej z krajín EÚ a EHP, v prípade schválenia samostatného Erasmus+ projektu UKF aj o mobilitu v rámci krajiny mimo EÚ a EHP priestoru.</p>
	<h3>Pre Erasmus mobilitu v krajine EÚ alebo EHP (mobility KA103) pozri:</h3>
	
	<ul>
		<li>Študijný pobyt (Student Mobility for Studies)</li>
		<li>Stáž (Student Mobility for Traineeships)</li>
		<li>Prednáškový pobyt (Teaching Mobility)</li>
		<li>Školenie (Staff Training Mobility)</li>
	</ul>
	...
	<p>Účastníci mobility majú nárok naďalší príspevok nad úroveň grantov na štúdium vo výške 100€/mesiac.Neplatí to pre študentov, ktorí poberajú sociálne štipendium</p>',
        ]);

        DB::table('faq')->insert([
            'name' => 'Čo vybavyť pred odchodom',
            'description' => '<p>Pred mobilitou je nevyhnutné vyplniť na prvej strane kontaktné údaje študenta, vysielajúcej a prijímajúcej inštitúcie. Všetky tri strany musia súhlasiť s časťou vyplnenou pred mobilitou.</p>
	<p>V prípade, že niektoré administratívne údaje sú už k dispozícií všetkým trom stranám, nie je potrebné ich opakovať v tomto vzore.</p>
	<p>Väčšina informácií o študentovi, vysielajúcej a prijímajúcej inštitúcii uvedených na strane 1 musí byť vložená do Mobility Tool+ (v prípade projektov Budovanie kapacít do EACEA Mobility Tool).</p>


	<p>Navrhnutý program mobility obsahuje predbežný mesiac začiatku a konca odsúhlaseného študijného programu, ktorého sa študent zúčastní v zahraničí.</p>

	<p>Zmluva o štúdiu musí zahŕňať všetky predmety, ktoré študent absolvuje v prijímajúcej inštitúcii (tabuľka A), a takisto musí obsahovať súbor predmetov, ktoré budú na vysielajúcej inštitúcii nahradené úspešným ukončením študijného programu v zahraničí (tabuľka B). Obidve tabuľky musia byť vyplnené ešte pred mobilitou. Riadky i stĺpce v tabuľkách možno v prípade potreby pridať. V každom prípade ale musia byť obe tabuľky A aj B uvedené samostatne, nemôžu sa zlučovať. Je to z toho dôvodu, aby bolo jasné, že jeden predmet študovaný v zahraničí nemusí korešpondovať s iným predmetom na vysielajúcej inštitúcii. Cieľom je skôr to, aby skupina vzdelávacích výstupov dosiahnutých v zahraničí nahradila skupinu vzdelávacích výstupov na vysielajúcej inštitúcii bez toho, aby bola nutná zhoda medzi istými modulmi alebo kurzami.</p>

	<p>V krajinách patriacich do Európskeho priestoru vysokoškolského vzdelávania (EHEA) je akademický rok denného štúdia tvorený predmetmi so súhrnným počtom 60 kreditov ECTS. Pre kratšie mobility, ako je jeden celý akademický rok, by predmety mali približne zodpovedať proporcionálnemu počtu kreditov (alebo ekvivalentných jednotiek v krajinách mimo EHEA). Ak študent navštevuje dodatočné predmety nad rámec tých, ktoré vyžaduje jeho študijný program, tieto dodatočné kredity (alebo ekvivalenty) musia byť tiež uvedené v študijnom programe v tabuľke A.</p>

	<p>Vysielajúca inštitúcia by mala uviesť v tabuľke B skupinu vzdelávacích komponentov, ktoré sa započítavajú do daného stupňa štúdia, ktoré by mal študent za normálnych podmienok absolvovať na vysielajúcej inštitúcii a ktoré budú nahradené študijným programom na prijímajúcej inštitúcii. Celkový počet ECTS kreditov (alebo ekvivalent) v tabuľke B by mal korešpondovať s celkovým počtom ECTS kreditov (alebo ekvivalent) v tabuľke A. Akákoľvek výnimka z tohto pravidla musí byť jasne uvedená v prílohe k Zmluve o štúdiu a odsúhlasená všetkými stranami. Príklad zdôvodnenia odchýlky medzi celkovým počtom ECTS kreditov (alebo ekvivalent) medzi tabuľkami A a B: napr.: študent už nazbieral potrebné kredity pre svoj stupeň a nepotrebuje niektoré z kreditov získaných v zahraničí.</p>

	<p>Odporúčaná úroveň hlavného jazyka výučby je uvedená v medziinštitucionálnej zmluve medzi vysielajúcou a prijímajúcou inštitúciou. Vysielajúca inštitúcia zodpovedá za poskytnutie jazykovej podpory vybraným uchádzačom, aby dosiahli požadovanú jazykovú úroveň do začiatku mobility.</p>

	<p>Úroveň jazykových kompetenciíí v hlavnom jazyku výučby, ktorú sa študent zaväzuje dosiahnúť do začiatku mobility, musí byť zaznamenaná v Zmluve o štúdiu, resp. v Zmluve o poskytnutí finančnej podpory.</p>
	
	<p>V prípade, ak vybraný študent nedosahuje stanovenú úroveň v čase podpisu Zmluvy o štúdiu (alebo Zmluvy o poskytnutí finančnej podpory), dohodne sa vysielajúca inštitúcia so študentom na spôsobe nadobudnutia danej úrovne do začiatku mobility. Takisto sa dohodnú na type jazykovej podpory, ktorú poskytne študentovi vysielajúca alebo prijímajúca inštitúcia.</p>',
        ]);

        DB::table('faq')->insert([
            'name' => 'Čo odovzdať po návrate',
            'description' => '<p>Prijímajúca inštitúcia sa zaväzuje poskytnúť vysielajúcej inštitúcii a študentovi Výpis výsledkov (tabuľka C) v dobe stanovenej v medziinštitucionálnej dohode (spravidla v dobe nie dlhšej ako 5 týždňov po uverejnení/vyhlásení výsledkov študenta v prijímajúcej inštitúcii). Výpis výsledkov môže odoslať elektronicky alebo iným spôsobom dostupným študentovi a vysielajúcej inštitúcii.</p>
	
	<p>Výpis výsledkov z prijímajúcej inštitúcie (Tabuľka C) by mal zodpovedať vzdelávacím komponentom odsúhlaseným v tabuľke A, a ak je to relevantné tak v tabuľke A2. Okrem toho by mala byť do Výpisu výsledkov zahrnutá alebo priložená informácia o prideľovaní známok (stačí odkaz na webovú stránku, kde je táto informácia zverejnená).</p>
	
	<p>Aktuálny začiatok a koniec mobility je:</p>

 	<p>Začiatok mobility je prvý deň, kedy študent musí byť prítomný v prijímajúcej inštitúcii. Môže to byť napríklad začiatok prvého kurzu, uvítacie podujatie organizované prijímajúcou inštitúciou, informačné stretnutie pre študentov so špeciálnymi potrebami, alebo jazykový a interkultúrny kurz; môže to zahŕňať aj jazykový kurz organizovaný alebo poskytovaný inou organizáciou ako prijímajúca inštitúcia (ak to vysielajúca inštitúcia považuje za relevantnú súčasť mobility v zahraničí).</p>

	<p>Koniec mobility je posledný deň, kedy je študent prítomný v prijímajúcej inštitúcii a nie jeho aktuálny dátum odchodu. To je napríklad koniec skúškového obdobia, koniec kurzu alebo povinnej osobnej účasti na vyučovaní.</p>
	
	<p>Po obdržaní Výpisu výsledkov z prijímajúcej inštitúcie by mala vysielajúca inštitúcia uznať študentovi úspešne ukončené predmety na prijímajúcej inštitúcii v celkovej výške ECTS kreditov (alebo ekvivalent) uvedených v Tabuľke B (ak je to relevantné tak v tabuľke B2) a započítať ich ako súčasť štúdia bez toho, aby si študent potreboval doplniť ďalšie kurzy alebo skúšky. </p>
	
	<p>Ak sa to vyžaduje, vysielajúca inštitúcia prevedie známky, ktoré získal študent v zahraničí, berúc do úvahy informácie o prideľovaní známok z prijímajúcej inštitúcie (pre vysoké školy z krajín programu pozri metodiku popísanú v ECTS príručke užívateľaiv). Európska komisia odporúča používať na tento účel nástroj EGRACONSv. </p>

	<p>Vysielajúca inštitúcia sa zaväzuje poskytnúť študentovi Výpis výsledkov (tabuľku D) alebo zaznamenať výsledky v databáze dostupnej študentovi, spravidla do 5 týždňov po obdržaní Výpisu výsledkov z prijímajúcej inštitúcie. </p>
	
	<p>Študent bude mať možnosť podať správu o uznaní výsledkov vzdelávania vysielajúcou inštitúciou prostredníctvom EU survey-u alebo iným dodatočným on-line dotazníkom.</p>

	<p>Dodatok k diplomu: Dodatok k diplomu vydaný vysielajúcou inštitúciou by mal obsahovať informácie obsiahnuté vo Výpise výsledkov z prijímajúcej inštitúcie s presnými názvami predmetov, ktoré študent absolvoval v zahraničí. Toto platí minimálne pre dodatok k diplomu, ktorý vydáva vysielajúca inštitúcia z krajín programu.</p>',
        ]);
    }
}