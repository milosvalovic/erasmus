            ...
            <div class="col-lg-6 col-sm-12">
                <div class="search-modal">
                    ...
                    <div class="input-items">
                        ...
                        {{--<br/>--}}
                        {{--<label for="from">Min. sadzba</label>--}}
                        {{--<input type="number" name="money" id="money" value="" placeholder="420€">--}}
                        {{--<label for="from">Typ mobility</label>--}}
                        {{--{{Form::select('stays', array("ERAZMUS", "CEEPUS", "Nezaradené"))}}--}}
