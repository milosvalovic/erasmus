        ...
        <div class="admin-content">
            <div class="my-profile-main-content">
                ...
                <div class="my-profile-pass-properties">
                    ...
                    <input type="password" class="form-control admin-form-input" id="myProfilePassNow" placeholder="Aktuálne heslo">
                    <input type="password" class="form-control admin-form-input" id="myProfilePassNew" placeholder="Nově heslo">
                    <input type="password" class="form-control admin-form-input" id="myProfilePassNewValidation" placeholder="Zopakovať heslo">
                    <div class="my-profile-confirm-div">

                        <button class="btn btn-outline-primary" id="myProfileChangePass">Zmeniť heslo</button>
                    </div>
                </div>
            </div>
        </div>
