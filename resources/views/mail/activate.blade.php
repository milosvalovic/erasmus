...
<head>
    ...
    <title>@lang('app.newsletter_activate')</title>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
                <tr>
                    <td align="center" bgcolor="#70bbd9" style="font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
                        <img src="{{ asset('img/activate_account_header.jpg') }}" alt="@lang('app.newsletter_activate')" width="749" height="207" style="display: block;" />
                    </td>
                </tr>
                <tr>
